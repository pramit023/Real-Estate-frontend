...
if(isWishlisted){
  ...
  console.error("Failed to toggle wishlists");
...
const fetchCounts=useCallback(async()=>{
  ...
  console.error("Failed to fetch property counts:");
  }
...
}, [fetchCounts, fetchProperties, fetchWishlist, user]);
      ...
      <section className={s.heroSection}>
        <div className={s.heroContent}>
          ...
          <p className={s.heroSubtitle}>
            Experience the most advanced real estate search palrtform. Discover verififed listings,connect with top agents,and find a palce you'll love.
           ...
           <div className={s.categoryHeaderText}>
                <h2 className={s.categoryTitle}>Browse by Category</h2>
                   <p className={s.categoryDesc}>
                    Explore curated collections of properties tailored to your  specific lifestyle and needs.</p>
            </div>
            </div>
            <div className={s.categoryGrid}>
             ...
             key={idx}
               ...
               <p className={s.categoryCount}>{cat.count.toLocaleString()}</p>
                  </div>
                    ))}
               </div>
